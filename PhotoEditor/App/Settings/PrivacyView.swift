...
struct PrivacyView: View {
        ...
        VStack {
            ...
            ScrollView {
                VStack(spacing: 16.adaptive()) {
                    Text("Privacy Policy for Join Sport")
    ...
    Application refers to Join Sport, the software program provided by the Company.

    Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to KOVALAN GROUP LTD, 2 Leman Street, London, England, E1 8FA.
    ...
    By email: a.kovalenko@kovalangroup.pro
    """#
}
